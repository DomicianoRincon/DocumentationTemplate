    ...
    >
      <Toolbar sx={{ minHeight: 64, display: 'flex', justifyContent: 'space-between' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <img src={courseLogo} alt="Logo" style={{ height: 36, width: 36 }} />
          <Typography
            variant="h6"
            sx={{
              color: theme.appBarText,
          ...
          >
            {/* FOUNDING A COURSE: replace with your short/long course name */}
            {isMobile ? 'Mi Curso' : 'Nombre completo del curso'}
          </Typography>
        </Box>
